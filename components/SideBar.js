...
const SideBar = () => {
  const { prevMonthDocuments, currentMonthDocuments } =
  ...
  useEffect(() => {
    ...
    const mostHearts = sortDocuments(currentMonthDocuments, "hearts")[0];
    const mostViews = sortDocuments(currentMonthDocuments, "views")[0];
  ...
  useEffect(() => {
    ...
    const mostHearts = sortDocuments(prevMonthDocuments, "hearts")[0];
    const mostViews = sortDocuments(prevMonthDocuments, "views")[0];
