...
export const WarningModal = styled.div`
  ...
  top: 50%;
  left: 50%;
  transform: ${({active}) => active ? 'translate(-50%, -50%) scale(1)' : 'translate(-50%, -50%) scale(0)'};
  background: #fff;
  box-shadow: 0 2px 4px 0 rgba(0, 0, 0, .1), 3px 6px 6px 0 rgba(0, 0, 0, .1), 4px 8px 8px 0 rgba(0, 0, 0, .1);
  padding: 15px 20px;
  border-radius: 10px;
